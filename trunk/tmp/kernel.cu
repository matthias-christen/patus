 ...
 * 
 * This code was generated by Patus on 2011/08/08 17:01:07
 */
...
__global__ void initialize_laplacian(float *  u_0_0, float *  u_0_1, float alpha, float beta, int x_max, int y_max, int z_max, int cb_x, int cb_y, int cb_z, int chunk)
{
	...
	*/
	/*
	for v2_idx_x = (((cb_x*(chunk*chunk))*(threadIdx.x+(blockDim.x*blockIdx.x)))+1)..((((cb_x*(chunk*chunk))*(threadIdx.x+(blockDim.x*blockIdx.x)))+1)+(chunk-1)) by 1 parallel 1 <level 1> schedule 1 { ... }
	*/
