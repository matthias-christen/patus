...
public final class Tools
{
  ...
  // SymbolTools
  /////////////////////////////////////////////////////////////////////////////
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void addSymbols(SymbolTable table, Declaration decl)
  {
    SymbolTools.addSymbols(table, decl);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Declaration findSymbol(SymbolTable table, IDExpression name)
  {
    return SymbolTools.findSymbol(table, name);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Declaration findSymbol(SymbolTable table, String name)
  {
    return SymbolTools.findSymbol(table, name);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated protected static List<SymbolTable> getParentTables(Traversable obj)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated protected static void removeSymbols(SymbolTable table, Declaration decl)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Identifier getTemp(Traversable where, Identifier id)
  {
    return SymbolTools.getTemp(where, id);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Identifier getTemp(Identifier id, String name)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Identifier getTemp(Traversable where, List specs, String name)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Identifier getPointerTemp(Traversable where, Identifier refID)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Set<Symbol> getVariableSymbols(SymbolTable st)
  {
    return SymbolTools.getVariableSymbols(st);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Set<Symbol> getGlobalSymbols(Traversable t)
  {
    return SymbolTools.getGlobalSymbols(t);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Set<Symbol> getParameterSymbols(Procedure proc)
  {
    return SymbolTools.getParameterSymbols(proc);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Set<Symbol> getSideEffectSymbols(FunctionCall fc)
  {
    return SymbolTools.getSideEffectSymbols(fc);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Set<Symbol> getAccessedSymbols(Traversable t)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Symbol getSymbolOfName(String name, Traversable tr)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean isGlobal(Symbol symbol, Traversable t)
  {
  ...
  /////////////////////////////////////////////////////////////////////////////
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void printlnStatus(Printable p, int min_verbosity)
  {
    PrintTools.printlnStatus(p, min_verbosity);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void printlnStatus(String message, int min_verbosity)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void println(String message, int min_verbosity)
  {
    PrintTools.println(message, min_verbosity);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void printStatus(Printable p, int min_verbosity)
  {
    PrintTools.printStatus(p, min_verbosity);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void printStatus(String message, int min_verbosity)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void printListWithComma(List list, PrintWriter w)
  {
    PrintTools.printListWithComma(list, w);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void printListWithSpace(List list, PrintWriter w)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static String collectionToString(Collection coll, String separator)
  {
    return PrintTools.collectionToString(coll, separator);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static String listToString(List list, String separator)
  {
    return PrintTools.listToString(list, separator);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static String listToStringWithSkip(List list, String separator)
  {
  ...
  (Map<Symbol, Set<Integer>> orig_map, Map<Symbol, Set<Integer>> new_map)
  {
    DataFlowTools.mergeSymbolMaps(orig_map, new_map);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void mergeMaps
  (Map<Expression, Set<Integer>> orig_map, Map<Expression, Set<Integer>> new_map)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Map<Symbol, Set<Integer>> getUseSymbolMap(Traversable t)
  {
    return DataFlowTools.getUseSymbolMap(t);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Map<Symbol, Set<Integer>> getDefSymbolMap(Traversable t)
  {
    return DataFlowTools.getDefSymbolMap(t);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Section.MAP
  getUseSectionMap(Expression e, RangeDomain rd, Set<Symbol> def_vars)
  {
    return DataFlowTools.getUseSectionMap(e, rd, def_vars);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Section.MAP
  getDefSectionMap(Expression e, RangeDomain rd, Set<Symbol> def_vars)
  {
    return DataFlowTools.getDefSectionMap(e, rd, def_vars);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Map<Expression, Set<Integer>> getUseMap(Traversable t)
  {
    return DataFlowTools.getUseMap(t);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void displayMap(Map<Expression, Set<Integer>> imap, String name)
  {
    DataFlowTools.displayMap(imap, name);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
/*
  @Deprecated public static Set<Expression> getFlatUseSet(Traversable t)
  {
    return DataFlowTools.getFlatUseSet(t);
  }
*/
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Map<Expression, Set<Integer>> getDefMap(Traversable t)
  {
    return DataFlowTools.getDefMap(t);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Section.MAP getDefSectionMap
  (Traversable t, Map range_map, RangeDomain unioned_rd, Set<Symbol> def_vars)
  {
    return DataFlowTools.getDefSectionMap(t, range_map, unioned_rd, def_vars);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
/*
  @Deprecated public static Set<Expression> getFlatDefSet(Traversable t)
  {
    return DataFlowTools.getFlatDefSet(t);
  }
*/
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
/*
  @Deprecated public static Set<Symbol> getFlatDefSymbol(Traversable t)
  {
    return DataFlowTools.getFlatDefSymbol(t);
  }
*/
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
/*
  @Deprecated public static Set<Symbol> getFlatUseSymbol(Traversable t)
  {
    return DataFlowTools.getFlatUseSymbol(t);
  }
*/
  ...
  /////////////////////////////////////////////////////////////////////////////
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean containsExpression(Traversable t, Expression e)
  {
    return IRTools.containsExpression(t, e);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static int countExpressions(Traversable t, Expression e)
  {
    return IRTools.countExpressions(t, e);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Expression findExpression(Traversable t, Expression e)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void replaceAll(Traversable t, Expression x, Expression y)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static TranslationUnit getParentTranslationUnit(Traversable t)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static DeclarationStatement getLastDeclarationStatement(Traversable t)
  {
    return IRTools.getLastDeclarationStatement(t);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static Statement getFirstNonDeclarationStatement(Traversable t)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static void replaceSymbolIn(Traversable t, Symbol var, Expression e)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean containsSymbol(Traversable t, Symbol var)
  {
    return IRTools.containsSymbol(t, var);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean containsSymbols(Traversable t, Set<Symbol> vars)
  {
    return IRTools.containsSymbols(t, vars);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean containsSymbols(Set<Symbol> vars, Set<Symbol> symbols)
  {
    return IRTools.containsSymbols(vars, symbols);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean containsClass(Traversable t, Class type)
  {
    return IRTools.containsClass(t, type);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean containsClasses(Traversable t, Set<Class> types)
  {
    return IRTools.containsClasses(t, types);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean containsBinary(Traversable t, BinaryOperator op)
  {
    return IRTools.containsBinary(t, op);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean containsUnary(Traversable t, UnaryOperator op)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static <T> T getAncestorOfType(Traversable t, Class<T> type)
  {
    return IRTools.getAncestorOfType(t, type);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static <T> List<T> getDescendentsOfType(Traversable t, Class<T> type)
  {
    return IRTools.getDescendentsOfType(t, type);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean isAncestorOf(Traversable anc, Traversable des)
  {
    return IRTools.isAncestorOf(anc, des);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static boolean isDescendantOf(Traversable des, Traversable anc)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static List<FunctionCall> getFunctionCalls(Traversable t)
  {
  ...
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static List<Statement> getLastStatements(Procedure proc)
  {
  ...
  @Deprecated public static <T extends Expression> List<T>
      getExpressionOfType(Traversable t, Class<? extends Expression> type)
  {
    return IRTools.getExpressionsOfType(t, type);
  }
  /** @deprecated As of release 1.2; use the new tools in {@link DataFlowTools}, {@link IRTools}, {@link PrintTools}, or {@link SymbolTools}. */
  @Deprecated public static List<Procedure> getProcedureList(Program program)
  {
