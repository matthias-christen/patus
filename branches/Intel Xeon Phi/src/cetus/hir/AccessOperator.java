...
{
  private static HashMap<String,AccessOperator> op_map = new HashMap(8);
   ...
   * .*
   */
  public static final AccessOperator MEMBER_DEREF_ACCESS = new AccessOperator(2);

  /**
   * -&gt;*
   */
  public static final AccessOperator POINTER_MEMBER_ACCESS = new AccessOperator(3);
