...
public class MayMod extends IPAnalysis
{
  ...
  {
    Domain maymods =
        new SetDomain<Symbol>(DataFlowTools.getDefSymbol(node.getProcedure()));
  ...
  public Set<CallSite> updateCalls(IPANode node) { return null; }

  public boolean updateCall(IPANode node) { return false; }
