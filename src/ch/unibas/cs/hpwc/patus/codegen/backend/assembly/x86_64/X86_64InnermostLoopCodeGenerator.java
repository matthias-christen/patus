...
public class X86_64InnermostLoopCodeGenerator extends InnermostLoopCodeGenerator
{
	...
	public X86_64InnermostLoopCodeGenerator (CodeGeneratorSharedObjects data, SubdomainIterator sdit, CodeGeneratorRuntimeOptions options)
	{
		super (data, sdit, options);
