...
public class WhileLoop extends Statement implements Loop, SymbolTable
{
  ...
  * @throws IllegalArgumentException if <b>condition</b> or <b>body</b> is null.
  ...
  */
  ...
  public WhileLoop clone()
  {
    ...
    DepthFirstIterator iter = new DepthFirstIterator(wl);
    iter.pruneOn(Declaration.class);
    iter.pruneOn(CompoundStatement.class);
    while (iter.hasNext()) {
      Object o = iter.next();
      if (o instanceof Declaration)
        SymbolTools.addSymbols(wl, (Declaration)o);
    }
    return wl;
  }
