...
public class ForLoop extends Statement implements Loop, SymbolTable
{
  ...
  * the condition expression <b>condition</b>, the step expression <b>step</b>,
  * and the body statement <b>body</b>. Any non-compound body statement is
  * internally normalized to a compound statement.
  *
  * @param init the initial statement.
  * @param condition the condition expression.
  * @param step the step expression.
  * @param body the body statement.
  * @throws NotAnOrphanException if <b>init</b>, <b>condition</b>, <b>step</b>,
  * or <b>body</b> has a parent.
  */
  public ForLoop
      (Statement init, Expression condition, Expression step, Statement body)
  {
    super(4);
  ...
  */
  ...
  /**
  * Returns the internal look-up table. This method is protected for consistent
  ...
  */
  ...
  public ForLoop clone()
  {
    ...
    DepthFirstIterator iter = new DepthFirstIterator(fl);
    iter.pruneOn(Declaration.class);
    iter.pruneOn(CompoundStatement.class);
    while (iter.hasNext()) {
      Object o = iter.next();
      if (o instanceof Declaration)
        SymbolTools.addSymbols(fl, (Declaration)o);
    }
    return fl;
  }
