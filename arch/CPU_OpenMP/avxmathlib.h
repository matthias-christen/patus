...
#   define AVX_ALIGN16_BEG __declspec(align(16))
#   define AVX_ALIGN16_END 
#else           /* gcc or icc */
#   define AVX_ALIGN16_BEG
#   define AVX_ALIGN16_END __attribute__((aligned(16)))
#endif

#define AVX_DECLARE_INT_CONST(Name, Val) \
    static const AVX_ALIGN16_BEG int Name##_PI32_[8] AVX_ALIGN16_END = { Val, Val, Val, Val, Val, Val, Val, Val };
#define AVX_DECLARE_LONG_CONST(Name, Val1, Val2) \
    static const AVX_ALIGN16_BEG int Name##_PI32_[8] AVX_ALIGN16_END = { Val1, Val2, Val1, Val2, Val1, Val2, Val1, Val2 };
...
#define _mm256_load1_ps(x) _mm256_set_ps
