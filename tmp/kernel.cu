 ...
 * 
 * This code was generated by Patus on 2011/08/12 18:29:06
 */
...
__device__ void laplacian___unroll_p3_20201(float *  *  u_0_1_out, float *  u_0_0, float *  u_0_1, float alpha, float beta, int x_max, int y_max, int z_max, int cb_x, int cb_y, int cb_z, int chunk)
{
	...
	*/
	...
	start0=(1+(((blockDim.x*blockIdx.x)+threadIdx.x)*(cb_x*chunk)));
	/*
	for v2_idx_x = start0..(start0+((cb_x*chunk)-1)) by cb_x parallel 1 <level 1> schedule 1 { ... }
	*/
	for (v2_idx_x=start0; v2_idx_x<=(start0+((cb_x*chunk)-1)); v2_idx_x+=cb_x)
	{
