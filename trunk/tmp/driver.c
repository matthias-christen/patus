						...
						for (pt_ref_idx_y=1; pt_ref_idx_y<(y_max+1); pt_ref_idx_y+=1)
						{
							for (pt_ref_idx_x=1; pt_ref_idx_x<(x_max+1); pt_ref_idx_x+=1)
							{
								...
								*/
								...
								u_0_1_ref[_idx7]=(sin((0.1*u_0_0_ref[_idx7]))+(0.2*((u_0_0_ref[_idx8]+(u_0_0_ref[_idx9]+u_0_0_ref[_idx10]))+(u_0_0_ref[_idx11]+(u_0_0_ref[_idx12]+u_0_0_ref[_idx13])))));
							}
						}
					}
				}
