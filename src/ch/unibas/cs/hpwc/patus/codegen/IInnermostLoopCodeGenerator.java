...
public interface IInnermostLoopCodeGenerator extends ICodeGenerator
{
	 ...
	 * @param sdit The subdomain iterator containing the innermost loop with a stencil computation
	 * 	for which to generate the code 
	 * @param options Code generation-time options
	 */
	@Override
