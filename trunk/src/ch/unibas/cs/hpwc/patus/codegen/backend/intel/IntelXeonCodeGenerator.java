...
public class IntelXeonCodeGenerator extends OpenMPCodeGenerator
{
	/**
	 * Constructor for the Intel Xeon Phi code generator
	 * @param data A CodeGeneratorSharedObjects 
	 */
	 ...
	 * </pre>
	 * @param strClause
	 * @param bAlloc is 1 if memory should be allocated. 0 If already alocated and should be reused.
